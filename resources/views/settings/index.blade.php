...
<form method="POST" action="{{ route('settings.update') }}" enctype="multipart/form-data" class="stack">
    ...
    <section class="card form-grid">
        ...
        <div>
            <label>Taux USD vers FC</label>
            <input type="number" step="0.0001" name="usd_to_fc_rate" value="{{ old('usd_to_fc_rate', $settings->usd_to_fc_rate ?? 2500) }}" required>
            <small class="muted">Valeur de 1 USD en francs congolais pour la vente et la facturation.</small>
        </div>
