...
<div class="card stack">
    ...
    <form method="GET" class="toolbar-form toolbar-form-wide" data-auto-filter-form>
        <div class="filter-field filter-field-search">
            <input type="text" name="search" value="{{ request('search') }}" placeholder="Numero, client ou commercial" data-auto-filter-input>
        </div>
        ...
        <table class="data-table data-table-dark-head">
            ...
            @forelse($invoices as $invoice)
                <tr>
                    ...
                    <td>{{ number_format($invoice->convertAmountForInvoice((float) $invoice->total_ttc), 2) }} {{ $invoice->invoiceCurrency() }}</td>
                    <td class="actions">
