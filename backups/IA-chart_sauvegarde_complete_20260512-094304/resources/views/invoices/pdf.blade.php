            ...
            <tbody>
                @foreach($invoice->details as $detail)
                    <tr>
                        ...
                        <td class="text-right">{{ number_format($detail->unit_price_ht, 2) }} {{ $settings->currency }}</td>
                        <td class="text-right">{{ number_format($detail->line_total_ht, 2) }} {{ $settings->currency }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
        ...
        <div class="totals">
            <table>
                <tr>
                    ...
                    <td class="text-right">{{ number_format($invoice->total_ht, 2) }} {{ $settings->currency }}</td>
                </tr>
                <tr>
                    <td class="totals-label">TVA {{ number_format($invoice->tax_rate, 2) }}%</td>
                    <td class="text-right">{{ number_format($invoice->tax_amount, 2) }} {{ $settings->currency }}</td>
                </tr>
                <tr class="grand-total">
                    <td>Total TTC</td>
                    <td class="text-right">{{ number_format($invoice->total_ttc, 2) }} {{ $settings->currency }}</td>
                </tr>
            </table>
        </div>
